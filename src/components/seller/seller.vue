        ...
        <div class="seller-content">
            <div class="info">
                <div class="title">
                    ...
                    <div class="collent" @click='collectflag = !collectflag'>
                        <svg class="icon collent-icon" aria-hidden="true" :class="{'active':collectflag}">
    ...
    methods:{
        _init(){
            axios.get('/static/data.json').then((res) =>{
                ...
                this.$nextTick(() =>{
                    let sellerScroll = new BScroll(this.$refs.sellerWrapper,{
                        click:true
                    })
                    this._initPicScroll()                    
                })
        ...
        _initPicScroll(){
            ...
            this.$refs.picList.style.width = (PIC_WIDTH + MARGIN) * picLen + 'px'
